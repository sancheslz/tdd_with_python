...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Usamos uma nova sessão de navegador para garantir que
        # nenhuma informação de Edith está vindo  de cookies, etc
        self.tearDown()
        self.setUp()

        # Francis acessa a página inicial. Não há nenhum sinal da
        # lista de Edith
        self.browser.get(self.live_server_url)
    ...
    def test_layout_and_styling(self):
        ...
        # Ela percebe que a caixa de entrada está
        # elegante e centralizada
        inputbox = self.browser.find_element_by_id('id_new_item')
        ...
        # Ela inicia uma nova lista e vê que a entrada
        # está elegantemente centralizada ai também
